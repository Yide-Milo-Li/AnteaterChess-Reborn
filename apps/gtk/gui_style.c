...
void gui_install_style(void) {
    ...
    static const char *css =
        ...
        ".confirm-dialog-body { background-color: #202020; border: 1px solid #de6a5f; border-radius: 7px; padding: "
        "14px; } "
        ".confirm-title { color: #fff1ed; font-weight: bold; font-size: 15px; } "
        ".confirm-message { color: #f8f5ee; } "
        ".confirm-icon-fallback { color: #fff1ed; background-color: #6b2d28; border: 1px solid #ff8b80; border-radius: "
        "999px; font-weight: bold; } "
        ".confirm-button-row { background-color: transparent; padding: 0 14px 14px 14px; } "
        "button { color: #fffaf0; background-image: none; background-color: #303030; border: 1px solid #8f846d; "
        ...
        "button.primary-button:disabled, button.primary-button:disabled label { color: #39301e; background-color: "
        "#9f7f3d; border-color: #8b7446; } "
        "button.ai-status-button, button.ai-status-button:disabled { color: #f7ffe9; background-color: #334829; "
        "border-color: #8cc36b; font-weight: bold; } "
        ...
        "entry, spinbutton { color: #ffffff; background-color: #0d0d0d; border: 1px solid #8f846d; border-radius: 5px; "
        "padding: 7px 8px; } "
        ...
        ".panel, .menu-panel, .setup-group, .board-panel, .match-bar { background-color: #242424; border: 1px solid "
        "#6f6656; border-radius: 7px; box-shadow: 0 8px 24px rgba(0, 0, 0, 0.34); } "
        ".panel { padding: 14px; } "
        ...
        "button.format-help { background-color: #303030; border: 1px solid #8f846d; border-radius: 999px; padding: "
        "4px; min-width: 32px; min-height: 32px; } "
        "button.format-help:hover { background-color: #463a22; border-color: #f0c15f; } "
        "button.format-help:active { background-color: #564325; border-color: #ffd987; } "
        ".format-popover { background-color: #111111; border: 1px solid #f0c15f; border-radius: 6px; padding: 10px; } "
        ".format-popover-title { color: #ffe0a3; font-weight: bold; } "
        ".format-popover-body { color: #f8f5ee; } "
        ".info-icon { color: #ffd071; font-weight: bold; } "
        ".match-bar { padding: 10px 12px; } "
        ".turn-banner { color: #111111; font-size: 18px; font-weight: bold; padding: 7px 16px; border-radius: 6px; "
        "background-color: #ffd071; border: 1px solid #ffe1a2; } "
        ...
        ".board-frame { background-color: #090909; border: 2px solid #a88a4d; border-radius: 6px; padding: 6px; "
        ...
        ".highlight-from { box-shadow: inset 0 0 0 3px rgba(255, 208, 113, 0.98), inset 0 0 14px rgba(255, 208, 113, "
        "0.42); } "
        ".highlight-destination { box-shadow: inset 0 0 0 3px rgba(120, 218, 106, 0.98), inset 0 0 14px rgba(120, 218, "
        "106, 0.42); } "
        ".highlight-selected { box-shadow: inset 0 0 0 4px rgba(255, 247, 230, 0.98), inset 0 0 16px rgba(255, 208, "
        "113, 0.52); } "
        ".hint-from { box-shadow: inset 0 0 0 4px rgba(56, 189, 248, 0.98), inset 0 0 18px rgba(56, 189, 248, 0.46); } "
        ".hint-destination { box-shadow: inset 0 0 0 4px rgba(250, 204, 21, 0.98), inset 0 0 18px rgba(250, 204, 21, "
        "0.48); } "
