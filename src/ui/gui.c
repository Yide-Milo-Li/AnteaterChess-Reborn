...
Gui *gui_create(int *argc, char ***argv) {
    ...
    gtk_css_provider_load_from_data(provider,
        ...
        ".hint-button:hover { background-color: #fde68a; border-color: #eab308; box-shadow: 0 0 12px rgba(250, 204, 21, 0.70); } "
        ".hint-glow { box-shadow: 0 0 10px rgba(250, 204, 21, 0.55); } "
