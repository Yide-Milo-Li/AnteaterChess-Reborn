...
void gui_install_style(void) {
    ...
    static const char *css =
        ...
        ".confirm-dialog-body { background-color: #202020; border: 1px solid #de6a5f; border-radius: 7px; padding: 14px; } "
        ...
        "button.format-help { background-color: #303030; border: 1px solid #8f846d; border-radius: 999px; padding: 4px; min-width: 32px; min-height: 32px; } "
